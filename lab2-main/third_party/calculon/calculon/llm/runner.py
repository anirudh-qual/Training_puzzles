...
class Runner(calculon.CommandLine):
    ...
    def create_parser(subparser):
        sp = subparser.add_parser(
            Runner.NAME, aliases=Runner.ALIASES, help="run a single llm calculation"
        )
        ...
        sp.add_argument(
            "execution", type=str, help="File path to execution configuration"
        )
        sp.add_argument("system", type=str, help="File path to system configuration")
        sp.add_argument(
            "stats", type=str, help='File path to stats output ("-" for stdout")'
        )
        sp.add_argument(
            "-p",
            "--peers",
